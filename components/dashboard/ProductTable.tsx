      ...
      <thead className="bg-slate-50 border-b">
        <tr>
          <th className="px-6 py-4 w-10">
            <button onClick={onToggleAll} className="text-slate-400">
            ...
            <tr key={product.id} className={`${isSelected ? 'bg-indigo-50/30' : 'hover:bg-slate-50'}`}>
              ...
              <td className="px-6 py-4">
                <div className="flex justify-center gap-1">
                  {isEditing ? (
                    <>
                      <button onClick={onSaveEdit} className="p-1.5 bg-green-100 text-green-700 rounded">
                        <SaveIcon size={14} />
                      </button>
                      <button onClick={onCancelEdit} className="p-1.5 bg-red-100 text-red-700 rounded">
                        <X size={14} />
                      </button>
                    </>
                  ) : (
                    <>
                      ...
                      <button onClick={() => onStartEdit(product)} className="p-1.5 bg-slate-100 text-slate-600 rounded">
                        <Edit size={14} />
                      </button>
                    </>
                  )}
